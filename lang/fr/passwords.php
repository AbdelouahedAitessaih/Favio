...
return [
    ...
    | aux raisons données par le gestionnaire de mots de passe pour une tentative
    | de mise à jour du mot de passe, comme un échec dû à un mot de passe invalide
    | ou un jeton de réinitialisation.
    |
    */
