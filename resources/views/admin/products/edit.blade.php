                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.products.update', $product) }}" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <x-text-input id="nom" class="block mt-1 w-full" type="text" name="nom" :value="old('nom', $product->nom)" required autofocus />
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="description" name="description" rows="4" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('description', $product->description) }}</textarea>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="prix" class="block mt-1 w-full" type="number" name="prix" step="0.01" min="0" :value="old('prix', $product->prix)" required />
                        ...
                        <div class="mt-4">
                            ...
                            >
                                ...
                                @foreach($categories as $categorie)
                                    <option value="{{ $categorie }}" {{ old('categorie', $product->categorie) == $categorie ? 'selected' : '' }}>
                                        {{ $categorie }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        @if($product->hasImage())
                            <div class="mt-4">
                                ...
                                <img src="{{ $product->image_url }}" alt="{{ $product->nom }}" class="mt-2 h-32 w-auto rounded">
                            </div>
                        @endif

                        <!-- Nouvelle image -->
                        <div class="mt-4">
                            <x-input-label for="image" :value="__('Nouvelle image')" />
                        ...
                        <div class="block mt-4">
                            <label for="est_actif" class="inline-flex items-center">
                                <input id="est_actif" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" name="est_actif" value="1" {{ old('est_actif', $product->est_actif) ? 'checked' : '' }}>
